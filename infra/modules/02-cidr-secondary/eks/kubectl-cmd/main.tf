...
#     cmd = format("%s %s %s", var.cmds[count.index], local.kubectl_kubeconfig_param, "\n")
#   }
...
#     # destroy_cmd = trim(format("%s %s", var.cmds[count.index], local.kubectl_kubeconfig_param), "\n")
#     destroy_cmd = format("%s %s %s", var.cmds[count.index], local.kubectl_kubeconfig_param, "\n")
